...
def generate_launch_description():
    ...
    ekf_config_file = LaunchConfiguration('ekf.yaml')
    ...
    declare_ekf_config_file_cmd = DeclareLaunchArgument(
        ...
        description='/home/hassan/dev_ws/learn_one/config/ekf.yaml'
    )
    ...
    package='robot_localization',  # Changed from learn_one
    executable='ekf_node',         # Official executable name
